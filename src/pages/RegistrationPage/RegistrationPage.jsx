...
const RegistrationPage = () => {
  return (
    <div
      className={`${s.wrapRegister} flex flex-col-reverse jusftify-center md:flex-row`}
    >
      <div
        className={`${s.boxRegister} w-full pt-8 pr-6 pb-8 pl-6  md:pt-10 md:pr-15 md:pb-10 md:pl-10 md:w-2xl `}
      >
